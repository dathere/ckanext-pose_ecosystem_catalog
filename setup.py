...
setup(
    ...
    entry_points='''
        [ckan.plugins]
        pose_custom_css=ckanext.pose_theme.pose_custom_css.plugin:PoseThemeCustomCSSPlugin
        pose_custom_homepage=ckanext.pose_theme.pose_custom_homepage.plugin:PoseThemeHomepagePlugin
